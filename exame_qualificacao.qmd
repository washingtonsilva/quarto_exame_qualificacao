...
Citações podem ser feitas com: @cruz_gonzalez_2017 estudaram. 

Ou após escrever um parágrafo [@cruz_gonzalez_2017], sendo que 
outras citações podem ser incluídas após uma vírgula.
...
Descrição dos dados que serão utilizados...
